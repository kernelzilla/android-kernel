...
#define CLK_NORATE(id, reg, br, h_r, h_c, h_b, tv) \
		CLK(id, NORATE, NULL, reg, NULL, NULL, 0, h_r, h_c, h_b, \
...
struct clk_local soc_clk_local_tbl[] = {
	...
	CLK_NORATE(DSI_ESC, MISC_CC_REG, B(0), DBG_BUS_VEC_B_REG,
	...
	CLK_NORATE(HDMI_APP, MISC_CC2_REG, B(11), DBG_BUS_VEC_B_REG,
	...
	/* AXI Interfaces */
	CLK_NORATE(GMEM_AXI,  MAXI_EN_REG, B(24), DBG_BUS_VEC_E_REG,
		HALT, 6, TEST_MMHS(0x23)),
	CLK_NORATE(JPEGD_AXI, MAXI_EN_REG, B(25), DBG_BUS_VEC_E_REG,
		HALT, 5, TEST_MMHS(0x29)),
	CLK_NORATE(VFE_AXI,   MAXI_EN_REG, B(18), DBG_BUS_VEC_E_REG,
		HALT, 0, TEST_MMHS(0x31)),

	/* AHB Interfaces */
	CLK_NORATE(AMP_P,   AHB_EN_REG, B(24),
		DBG_BUS_VEC_F_REG, HALT, 18, TEST_MMLS(0x0D)),
	CLK_NORATE(APU_P,    AHB_EN_REG, B(28),
		DBG_BUS_VEC_F_REG, HALT,  8, TEST_MMLS(0x49)),
	CLK_NORATE(CSI0_P,   AHB_EN_REG, B(7),
		DBG_BUS_VEC_H_REG, HALT, 14, TEST_MMLS(0x0F)),
	CLK_NORATE(CSI1_P,   AHB_EN_REG, B(20),
		DBG_BUS_VEC_H_REG, HALT, 13, TEST_MMLS(0x11)),
	CLK_NORATE(DSI_M_P,  AHB_EN_REG, B(9),
		DBG_BUS_VEC_F_REG, HALT, 19, TEST_MMLS(0x13)),
	CLK_NORATE(FAB_P,    AHB_EN_REG, B(31),
		DBG_BUS_VEC_F_REG, HALT,  1, TEST_MMLS(0x17)),
	CLK_NORATE(IJPEG_P,  AHB_EN_REG, B(5),
		DBG_BUS_VEC_F_REG, HALT,  9,  TEST_MMLS(0x23)),
	CLK_NORATE(JPEGD_P,  AHB_EN_REG, B(21),
		DBG_BUS_VEC_F_REG, HALT,  7,  TEST_MMLS(0x27)),
	CLK_NORATE(MDP_P,    AHB_EN_REG, B(10),
		DBG_BUS_VEC_F_REG, HALT, 11,  TEST_MMLS(0x29)),
	CLK_NORATE(ROT_P,    AHB_EN_REG, B(12),
		DBG_BUS_VEC_F_REG, HALT, 13, TEST_MMLS(0x2D)),
	CLK_NORATE(TV_ENC_P, AHB_EN_REG, B(25),
		DBG_BUS_VEC_F_REG, HALT, 23, TEST_MMLS(0x33)),
	CLK_NORATE(VFE_P,    AHB_EN_REG, B(13),
		DBG_BUS_VEC_F_REG, HALT, 14, TEST_MMLS(0x37)),
	CLK_NORATE(VPE_P,    AHB_EN_REG, B(16),
