...
{
//This was added based on Qcom SR 00176377 and this helps the kernel to apply the different
//compressor profiles.  At first there was only ONE set of compressor settings for all devices
//We've now incorporated 3 different compressor profiles and the MODS below will allow for each
//device to use their own set of ADRC compressor settings if they're enabled.
...
static long audio_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case AUDIO_GET_CONFIG: {
		...
		config.unused[1] = 0;
		config.unused[2] = 0;
// commented out by jwnd84... there's only 3 elements in this array!!!
//		config.unused[3] = 0;
