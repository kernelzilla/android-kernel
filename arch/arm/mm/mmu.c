 ...
 *  Copyright (C) Motorola, Inc. 2007-2009
 *
 ...
 * Date         Author   Comment
 * -----------  -------  -----------------------------------
 * 11/05/2007   Motorola add support for LTT-LITE
 *
 */
...
void __init reserve_node_zero(pg_data_t *pgdat)
{
	...
	if (ltt_lite_res.start) {
		...
		reserve_bootmem_node(pgdat, ltt_lite_res.start, ltt_lite_res.end - ltt_lite_res.start+1, BOOTMEM_DEFAULT);
	}
#endif
	if (res_size)
