...
extern struct platform_device cpcap_display_led;
extern struct platform_device cpcap_keypad_led;
...
struct regulator_consumer_supply cpcap_sw5_consumers[] = {
	...
	REGULATOR_CONSUMER("sw5", &cpcap_display_led.dev),
	REGULATOR_CONSUMER("sw5", &cpcap_keypad_led.dev),
#ifdef CONFIG_LEDS_AF_LED
