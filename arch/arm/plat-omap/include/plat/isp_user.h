...
#define VIDIOC_PRIVATE_ISP_RESIZE_DATA \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 10, struct isp_mem_resize_data)

#define VIDIOC_PRIVATE_ISP_PROCESS_DATA \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 11, struct isp_mem_data)
...
#define VIDIOC_PRIVATE_OMAP34XXCAM_SENSOR_INFO	\
	_IOWR('V', BASE_VIDIOC_PRIVATE + 20, struct omap34xxcam_sensor_info)
