...
static unsigned long balance_pgdat(pg_data_t *pgdat, int order)
{
	...
	if(reclaim_state == NULL) return 0;  // happens once in a rare.
					// it is possible that current->reclaim_state is null, yet
					// there is nothing keeping this from blowing up the kernel here.
