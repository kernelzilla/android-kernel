...
#define LIS331DLH_IOCTL_SET_POLLINTERVAL     _IOW(LIS331DLH_IOCTL_BASE, 0, int)
#define LIS331DLH_IOCTL_TRIGGER_POLLHANDLER   _IO(LIS331DLH_IOCTL_BASE, 1)
#define LIS331DLH_IOCTL_SET_ENABLE           _IOW(LIS331DLH_IOCTL_BASE, 2, int)
#define LIS331DLH_IOCTL_GET_ENABLE            _IO(LIS331DLH_IOCTL_BASE, 3)
