...
#if defined(CONFIG_MACH_CALGARY) || defined(CONFIG_MACH_PITTSBURGH) || defined (CONFIG_MACH_SOCIAL)
#include <mach/board.h>
#include "board-mot.h" //GPIO/I2C addresses

#define FAN5646_GPIO MSG_IND_LED_CTRL
#else /* defined(CONFIG_MACH_CALGARY) || defined(CONFIG_MACH_PITTSBURGH)|| defined (CONFIG_MACH_SOCIAL) */
#define FAN5646_GPIO 100
#endif /* defined(CONFIG_MACH_CALGARY) || defined(CONFIG_MACH_PITTSBURGH)|| defined (CONFIG_MACH_SOCIAL) */
...
#if !defined(CONFIG_MACH_CALGARY) && !defined(CONFIG_MACH_MOT) && !defined(CONFIG_MACH_PITTSBURGH) && !defined(CONFIG_MACH_SOCIAL)
