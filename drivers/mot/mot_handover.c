...
#define PU_MAIN_PANIC mot_handover_data->phone_handover.modem_panic
...
#endif /* defined(CONFIG_MACH_CALGARY) */
...
FUNCTION:
   mot_handover_get_panic

DESCRIPTION:
   This function is to be used by anyone wishing to read the last modem panic.
...
RETURN VALUE:
   void* ptr - pointer to a panic buffer. It will return NULL when there is no panic.
...
==================================================================================================*/
void *mot_handover_get_panic( void )
{
  BOOLEAN err = FALSE;
  void *ret = NULL;
