 ...
 * 02111-1307, USA
 *
 * Motorola 2010 - porting from calgary by pktb76
 */
...
/** \def SFH7743_IOCTL_BASE
 *  \brief Base IOCTL number
 */
#define SFH7743_IOCTL_BASE 37
/** \def SFH7743_IOCTL_*
 *  \brief The following define the IOCTL command values via the ioctl macros
 */
#define SFH7743_IOCTL_GET_PRESENCE     _IO( SFH7743_IOCTL_BASE, 0)
#define SFH7743_IOCTL_PUSH_PRESENCE    _IO( SFH7743_IOCTL_BASE, 1)
#define SFH7743_IOCTL_ENABLE           _IO( SFH7743_IOCTL_BASE, 2)
#define SFH7743_IOCTL_DISABLE          _IO( SFH7743_IOCTL_BASE, 3)
#define SFH7743_IOCTL_GET_STATUS       _IO( SFH7743_IOCTL_BASE, 4)
...
static int sfh7743_fops_ioctl (struct inode *inode, struct file *filp, unsigned int cmd, unsigned long arg)
{
   ...
   sfh7743_log(KERN_INFO "sfh7743_fops_ioctl: Enter... \n");
...
static int sfh7743_fops_write (struct file *filp, const char __user *buf, size_t count, loff_t *f_pos)
{
	...
	sfh7743_log(KERN_INFO "sfh7743_fops_write: writebuf = [%s] \n", writeBuf);
...
static int sfh7743_config_int (struct platform_device *pdev)
{
   ...
   sfh7743_log(KERN_INFO "sfh7743_config_init: Enter... \n");
...
static int	sfh7743_probe(struct platform_device *pdev)
{
   ...
   if (error == E_OK)
   {
      sfh7743_log(KERN_INFO "sfh7743_probe: initialized gpio_int[%d] irq[%d] gpio_en[%d] vreg_en[%s]\n",
         sfh7743_info.gpio_intr, sfh7743_info.irq, sfh7743_info.gpio_en, sfh7743_info.vreg_name);
   }
   else
   {
   ...
   sfh7743_log(KERN_INFO "sfh7743_probe: Return....\n");
...
{
   sfh7743_log(KERN_INFO "sfh7743_irq_handler: Enter....\n");
   disable_irq (irq);
...
void sfh7743_irq_bottom_half (struct work_struct *work)
{
   ...
   sfh7743_log(KERN_INFO "sfh7743_irq_bottom_half: Enter....\n");
...
{
   sfh7743_log(KERN_INFO "sfh7743_post_data: presence [%x]\n", distance);
...
{
    sfh7743_log(KERN_INFO "sfh7743_enable: Enter.... \n");
	/* If enable requested */
...
{
	sfh7743_log(KERN_INFO "sfh7743_get_distance: Enter.... \n");
...
int sfh7743_register (void)
{
   ...
   sfh7743_log(KERN_INFO "sfh7743_register: Enter.... \n");
...
{
   sfh7743_log(KERN_INFO "sfh7743_unregister: Enter.... \n");
...
{
	sfh7743_log(KERN_INFO "sfh7743_set_mode: mode = [%s] \n", buf);
