...
static void omap_hsmmc_dump_registers(struct omap_hsmmc_host *host)
{
	printk(KERN_INFO "SYSCONFIG:\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, SYSCONFIG));
	printk(KERN_INFO "SYSSTATUS:\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, SYSSTATUS));
	printk(KERN_INFO "CON:\t\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, CON));
	printk(KERN_INFO "BLK:\t\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, BLK));
	printk(KERN_INFO "ARG:\t\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, ARG));
	printk(KERN_INFO "CMD:\t\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, CMD));
	printk(KERN_INFO "RSP10:\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, RSP10));
	printk(KERN_INFO "RSP32:\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, RSP32));
	printk(KERN_INFO "RSP54:\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, RSP54));
	printk(KERN_INFO "RSP76:\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, RSP76));
	printk(KERN_INFO "DATA:\t\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, DATA));
	printk(KERN_INFO "HCTL:\t\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, HCTL));
	printk(KERN_INFO "SYSCTL:\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, SYSCTL));
	printk(KERN_INFO "STAT:\t\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, STAT));
	printk(KERN_INFO "IE:\t\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, IE));
	printk(KERN_INFO "ISE:\t\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, ISE));
	printk(KERN_INFO "CAPA:\t\t0x%08x\n",
			OMAP_HSMMC_READ(host->base, CAPA));
}

static void omap_hsmmc_dump_host(struct omap_hsmmc_host *host)
{
	printk(KERN_INFO "flags:\t0x%08lx\n", host->flags);
	printk(KERN_INFO "id:\t\t%u\n", host->id);
	printk(KERN_INFO "dma_len:\t%u\n", host->dma_len);
	printk(KERN_INFO "dma_sg_idx:\t%u\n", host->dma_sg_idx);
	printk(KERN_INFO "bus_mode:\t%d\n", host->bus_mode);
	printk(KERN_INFO "power_mode:\t%d\n", host->power_mode);
	printk(KERN_INFO "bytesleft:\t%u\n", host->bytesleft);
	printk(KERN_INFO "suspended:\t%d\n", host->suspended);
	printk(KERN_INFO "irq:\t\t%d\n", host->irq);
	printk(KERN_INFO "use_dma:\t%d\n", host->use_dma);
	printk(KERN_INFO "dma_ch:\t%d\n", host->dma_ch);
	printk(KERN_INFO "dma_line_tx:\t%d\n", host->dma_line_tx);
	printk(KERN_INFO "dma_line_rx:\t%d\n", host->dma_line_rx);
	printk(KERN_INFO "slot_id:\t%d\n", host->slot_id);
	printk(KERN_INFO "got_dbclk:\t%d\n", host->got_dbclk);
	printk(KERN_INFO "response_busy:%d\n", host->response_busy);
	printk(KERN_INFO "context_loss:\t%d\n", host->context_loss);
	printk(KERN_INFO "dpm_state:\t%d\n", host->dpm_state);
	printk(KERN_INFO "vdd:\t\t%d\n", host->vdd);
	printk(KERN_INFO "protect_card:\t%d\n", host->protect_card);
	printk(KERN_INFO "reqs_blocked:\t%d\n", host->reqs_blocked);
}
...
static irqreturn_t omap_hsmmc_irq(int irq, void *dev_id)
{
	...
	if (status & ERR) {
		...
		omap_hsmmc_dump_host(host);
		omap_hsmmc_dump_registers(host);
...
static void omap_hsmmc_set_ios(struct mmc_host *mmc, struct mmc_ios *ios)
{
	...
	printk(KERN_DEBUG "%s: power_mode=%d, bus_width=%d, dsor=%d,"
