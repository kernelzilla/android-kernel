				...
				PUBLIC_CRYPTO_AES_OPERATION_STATE *pAESState)
{
	 ...
	 */
	AES_CTRL = (INREG32(&pAESReg_t->AES_CTRL) & (3 << 3)) |
		(AES_CTRL & ((1 << 2) | (1 << 5) | (1 << 6))) | (0x3 << 7)
		/* key size */
			/* CTR, CBC, DIRECTION */
...
ch0_parameters.data_type |= DMA_CSDP_Dest_Burst_16B | DMA_CSDP_Src_Burst_16B;
		...
		/*specific data_type field for AES */
ch1_parameters.data_type |= DMA_CSDP_Dest_Burst_16B | DMA_CSDP_Src_Burst_16B;
