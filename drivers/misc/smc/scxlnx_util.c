      ...
      SCX_COMMAND_MESSAGE *pMessage)
{
   ...
   dprintk(
      KERN_DEBUG "message@%p: \n",
      pMessage);

   switch (pMessage->nMessageType) {
   case SCX_MESSAGE_TYPE_CREATE_DEVICE_CONTEXT:
      dprintk(
         KERN_DEBUG "   nMessageType             = SCX_MESSAGE_TYPE_CREATE_DEVICE_CONTEXT\n"
         ...
         pMessage->sBody.sCreateDeviceContextMessage.nSharedMemDescriptors[1],
         pMessage->sBody.sCreateDeviceContextMessage.nSharedMemDescriptors[2],
         pMessage->sBody.sCreateDeviceContextMessage.nSharedMemDescriptors[3],
         pMessage->sBody.sCreateDeviceContextMessage.nSharedMemDescriptors[4],
         pMessage->sBody.sCreateDeviceContextMessage.nSharedMemDescriptors[5],
         pMessage->sBody.sCreateDeviceContextMessage.nSharedMemDescriptors[6],
         pMessage->sBody.sCreateDeviceContextMessage.nSharedMemDescriptors[7],
   ...
   case SCX_MESSAGE_TYPE_DESTROY_DEVICE_CONTEXT:
      dprintk(
         KERN_DEBUG "   nMessageType    = SCX_MESSAGE_TYPE_DESTROY_DEVICE_CONTEXT\n"
         KERN_DEBUG "   nOperationID    = 0x%08X\n"
         KERN_DEBUG "   hDeviceContext  = 0x%08X\n",
         pMessage->nOperationID,
         pMessage->sBody.sDestroyDeviceContextMessage.hDeviceContext);
      break;

   case SCX_MESSAGE_TYPE_OPEN_CLIENT_SESSION:
      dprintk(
         KERN_DEBUG "   nMessageType                = SCX_MESSAGE_TYPE_OPEN_CLIENT_SESSION\n"
         KERN_DEBUG "   nOperationID                = 0x%08X\n"
         KERN_DEBUG "   hDeviceContext            = 0x%08X\n"
         ...
         pMessage->sBody.sOpenClientSessionMessage.nClientOperationID,
         pMessage->sBody.sOpenClientSessionMessage.sTimeout[0],
         pMessage->sBody.sOpenClientSessionMessage.sTimeout[1],
         pMessage->sBody.sOpenClientSessionMessage.nClientParameterStartOffset,
         pMessage->sBody.sOpenClientSessionMessage.nClientParameterSize,
         pMessage->sBody.sOpenClientSessionMessage.nClientAnswerStartOffset,
         pMessage->sBody.sOpenClientSessionMessage.nClientAnswerSizeMax);


      switch (pMessage->sBody.sOpenClientSessionMessage.nLoginType) {
      case S_LOGIN_PUBLIC:
         dprintk(
            KERN_DEBUG "   nLoginType              = S_LOGIN_PUBLIC\n");
         break;

      case S_LOGIN_OS_IDENTIFICATION:
         pIdentifier = (SCX_UUID *) &(pMessage->sBody.sOpenClientSessionMessage.sLoginData[0]);
         dprintk(
            KERN_DEBUG "   nLoginType              = S_LOGIN_OS_IDENTIFICATION\n"
            KERN_DEBUG "   sUUID                  = %08X-%04X-%04X-%02X%02X-%02X%02X%02X%02X%02X%02X\n",
      ...
      case S_LOGIN_AUTHENTICATION:
         ...
         dprintk(
            KERN_DEBUG "   nLoginType              = S_LOGIN_AUTHENTICATION\n"
            KERN_DEBUG "   ssClientHash             = %02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X\n",
      ...
      case S_LOGIN_PRIVILEGED:
         dprintk(
            KERN_DEBUG "   nLoginType              = S_LOGIN_PRIVILEGED\n");
         break;

      default:
         dprintk(
            KERN_ERR "  nLoginType              = 0x%08X (Unknown login type)\n",
   ...
   case SCX_MESSAGE_TYPE_CLOSE_CLIENT_SESSION:
      dprintk(
         KERN_DEBUG "   nMessageType                = SCX_MESSAGE_TYPE_CLOSE_CLIENT_SESSION\n"
         KERN_DEBUG "   nOperationID                = 0x%08X\n"
         KERN_DEBUG "   hDeviceContext            = 0x%08X\n"
         ...
         pMessage->sBody.sCloseClientSessionMessage.hClientSession,
         pMessage->sBody.sCloseClientSessionMessage.nClientParameterStartOffset,
         pMessage->sBody.sCloseClientSessionMessage.nClientParameterSize,
         pMessage->sBody.sCloseClientSessionMessage.nClientAnswerStartOffset,
         pMessage->sBody.sCloseClientSessionMessage.nClientAnswerSizeMax);
      break;

   case SCX_MESSAGE_TYPE_REGISTER_SHARED_MEMORY:
      dprintk(
         KERN_DEBUG "   nMessageType             = SCX_MESSAGE_TYPE_REGISTER_SHARED_MEMORY\n"
         KERN_DEBUG "   nOperationID             = 0x%08X\n"
         KERN_DEBUG "   hDeviceContext         = 0x%08X\n"
         KERN_DEBUG "   hClientSession         = 0x%08X\n"
         ...
         pMessage->sBody.sRegisterSharedMemoryMessage.hClientSession,
         pMessage->sBody.sRegisterSharedMemoryMessage.nBlockID,
         pMessage->sBody.sRegisterSharedMemoryMessage.nSharedMemDescriptors[0],
         pMessage->sBody.sRegisterSharedMemoryMessage.nSharedMemDescriptors[1],
         pMessage->sBody.sRegisterSharedMemoryMessage.nSharedMemDescriptors[2],
         pMessage->sBody.sRegisterSharedMemoryMessage.nSharedMemDescriptors[3],
         pMessage->sBody.sRegisterSharedMemoryMessage.nSharedMemDescriptors[4],
         pMessage->sBody.sRegisterSharedMemoryMessage.nSharedMemDescriptors[5],
         pMessage->sBody.sRegisterSharedMemoryMessage.nSharedMemDescriptors[6],
         pMessage->sBody.sRegisterSharedMemoryMessage.nSharedMemDescriptors[7],
   ...
   case SCX_MESSAGE_TYPE_RELEASE_SHARED_MEMORY:
      dprintk(
         KERN_DEBUG "   nMessageType    = SCX_MESSAGE_TYPE_RELEASE_SHARED_MEMORY\n"
         KERN_DEBUG "   nOperationID    = 0x%08X\n"
         KERN_DEBUG "   hDeviceContext  = 0x%08X\n"
   ...
   case SCX_MESSAGE_TYPE_INVOKE_CLIENT_COMMAND:
      dprintk(
         KERN_DEBUG "   nMessageType                = SCX_MESSAGE_TYPE_INVOKE_CLIENT_COMMAND\n"
         KERN_DEBUG "   nOperationID                = 0x%08X\n"
         KERN_DEBUG "   hDeviceContext            = 0x%08X\n"
         KERN_DEBUG "   hClientSession            = 0x%08X\n"
         KERN_DEBUG "   sTimeout                  = 0x%08X%08X\n"
         ...
         pMessage->sBody.sInvokeClientCommandMessage.sTimeout[0],
         pMessage->sBody.sInvokeClientCommandMessage.sTimeout[1],
         pMessage->sBody.sInvokeClientCommandMessage.nClientOperationID,
         pMessage->sBody.sInvokeClientCommandMessage.nClientCommandIdentifier,
         pMessage->sBody.sInvokeClientCommandMessage.nClientParameterBlock,
         pMessage->sBody.sInvokeClientCommandMessage.nClientParameterStartOffset,
         pMessage->sBody.sInvokeClientCommandMessage.nClientParameterSize,
         pMessage->sBody.sInvokeClientCommandMessage.hClientAnswerBlock,
         pMessage->sBody.sInvokeClientCommandMessage.nClientAnswerStartOffset,
         pMessage->sBody.sInvokeClientCommandMessage.nClientAnswerSizeMax);
      break;

   case SCX_MESSAGE_TYPE_CANCEL_CLIENT_COMMAND:
      dprintk(
         KERN_DEBUG "   nMessageType       = SCX_MESSAGE_TYPE_CANCEL_CLIENT_COMMAND\n"
         KERN_DEBUG "   nOperationID       = 0x%08X\n"
         KERN_DEBUG "   hDeviceContext   = 0x%08X\n"
         KERN_DEBUG "   hClientSession   = 0x%08X\n"
         KERN_DEBUG "   nClientOperationID = 0x%08X\n",
         ...
         pMessage->sBody.sCancelClientOperationMessage.hClientSession,
         pMessage->sBody.sCancelClientOperationMessage.nClientOperationID);
      break;

   case SCX_MESSAGE_TYPE_POWER_MANAGEMENT:
      dprintk(
         KERN_DEBUG "   nMessageType             = SCX_MESSAGE_TYPE_POWER_MANAGEMENT\n"
         KERN_DEBUG "   nOperationID             = 0x%08X\n"
         ...
         pMessage->sBody.sPowerManagementMessage.nSharedMemDescriptors[0],
         pMessage->sBody.sPowerManagementMessage.nSharedMemDescriptors[1],
         pMessage->sBody.sPowerManagementMessage.nSharedMemStartOffset,
         pMessage->sBody.sPowerManagementMessage.nSharedMemSize);
      break;

   default:
      dprintk(
         KERN_ERR "  nMessageType = 0x%08X (Unknown message type)\n",
      ...
      SCX_ANSWER_MESSAGE *pAnswer)
{
   ...
   case SCX_MESSAGE_TYPE_CREATE_DEVICE_CONTEXT:
      dprintk(
         KERN_DEBUG "   nMessageType    = SCX_ANSWER_CREATE_DEVICE_CONTEXT\n"
         KERN_DEBUG "   nOperationID    = 0x%08X\n"
         KERN_DEBUG "   nSChannelStatus = 0x%08X\n"
         KERN_DEBUG "   hDeviceContext  = 0x%08X\n",
         pAnswer->nOperationID,
         pAnswer->nSChannelStatus,
         pAnswer->sBody.sCreateDeviceContextAnswer.hDeviceContext);
      break;

   case SCX_MESSAGE_TYPE_DESTROY_DEVICE_CONTEXT:
      dprintk(
         KERN_DEBUG "   nMessageType    = ANSWER_DESTROY_DEVICE_CONTEXT\n"
         KERN_DEBUG "   nOperationID    = 0x%08X\n"
         KERN_DEBUG "   nSChannelStatus = 0x%08X\n",
         pAnswer->nOperationID,
         pAnswer->nSChannelStatus);
   ...
   case SCX_MESSAGE_TYPE_OPEN_CLIENT_SESSION:
      dprintk(
         KERN_DEBUG "   nMessageType      = SCX_ANSWER_OPEN_CLIENT_SESSION\n"
         KERN_DEBUG "   nOperationID      = 0x%08X\n"
         KERN_DEBUG "   nSChannelStatus   = 0x%08X\n"
         ...
         pAnswer->nOperationID,
         pAnswer->nSChannelStatus,
         pAnswer->sBody.sOpenClientSessionAnswer.nFrameworkStatus,
         pAnswer->sBody.sOpenClientSessionAnswer.nServiceError,
         pAnswer->sBody.sOpenClientSessionAnswer.hClientSession,
         pAnswer->sBody.sOpenClientSessionAnswer.nClientAnswerSize);
      break;

   case SCX_MESSAGE_TYPE_CLOSE_CLIENT_SESSION:
      dprintk(
         KERN_DEBUG "   nMessageType      = ANSWER_CLOSE_CLIENT_SESSION\n"
         KERN_DEBUG "   nOperationID      = 0x%08X\n"
         KERN_DEBUG "   nSChannelStatus   = 0x%08X\n"
         KERN_DEBUG "   nFrameworkStatus  = 0x%08X\n"
         KERN_DEBUG "   nServiceError    = 0x%08X\n"
         ...
         pAnswer->nOperationID,
         pAnswer->nSChannelStatus,
         pAnswer->sBody.sCloseClientSessionAnswer.nFrameworkStatus,
         pAnswer->sBody.sCloseClientSessionAnswer.nServiceError,
         pAnswer->sBody.sCloseClientSessionAnswer.nClientAnswerSize);
      break;

   case SCX_MESSAGE_TYPE_REGISTER_SHARED_MEMORY:
      dprintk(
         KERN_DEBUG "   nMessageType    = SCX_ANSWER_REGISTER_SHARED_MEMORY\n"
         KERN_DEBUG "   nOperationID    = 0x%08X\n"
         KERN_DEBUG "   nSChannelStatus = 0x%08X\n"
         KERN_DEBUG "   hBlock          = 0x%08X\n",
         pAnswer->nOperationID,
   ...
   case SCX_MESSAGE_TYPE_RELEASE_SHARED_MEMORY:
      dprintk(
         KERN_DEBUG "   nMessageType    = ANSWER_RELEASE_SHARED_MEMORY\n"
         KERN_DEBUG "   nOperationID    = 0x%08X\n"
         KERN_DEBUG "   nSChannelStatus = 0x%08X\n"
         KERN_DEBUG "   nBlockID      = 0x%08X\n",
         pAnswer->nOperationID,
   ...
   case SCX_MESSAGE_TYPE_INVOKE_CLIENT_COMMAND:
      dprintk(
         KERN_DEBUG "   nMessageType      = SCX_ANSWER_INVOKE_CLIENT_COMMAND\n"
         KERN_DEBUG "   nOperationID      = 0x%08X\n"
         KERN_DEBUG "   nSChannelStatus   = 0x%08X\n"
         KERN_DEBUG "   nFrameworkStatus  = 0x%08X\n"
         KERN_DEBUG "   nServiceError    = 0x%08X\n"
         ...
         pAnswer->nOperationID,
         pAnswer->nSChannelStatus,
         pAnswer->sBody.sInvokeClientCommandAnswer.nFrameworkStatus,
         pAnswer->sBody.sInvokeClientCommandAnswer.nServiceError,
         pAnswer->sBody.sInvokeClientCommandAnswer.nClientAnswerSize);
      break;

   case SCX_MESSAGE_TYPE_CANCEL_CLIENT_COMMAND:
      dprintk(
         KERN_DEBUG "   nMessageType      = SCX_ANSWER_CANCEL_CLIENT_COMMAND\n"
         KERN_DEBUG "   nOperationID      = 0x%08X\n"
         KERN_DEBUG "   nSChannelStatus   = 0x%08X\n",
         pAnswer->nOperationID,
         pAnswer->nSChannelStatus);
   ...
   case SCX_MESSAGE_TYPE_POWER_MANAGEMENT:
      dprintk(
         KERN_DEBUG "   nMessageType      = SCX_ANSWER_POWER_MANAGEMENT\n"
         KERN_DEBUG "   nOperationID      = 0x%08X\n"
         KERN_DEBUG "   nSChannelStatus   = 0x%08X\n",
         pAnswer->nOperationID,
         pAnswer->nSChannelStatus);
 ...
 */
static void SCXLNXConnUUIDFromHash(
      const u8 *pHashData,
      SCX_UUID *pIdentifier)
{
   /*
    *Based on the algorithm described in section 4.3, "Algorithm for Creating
    * a Name-Based UUID", of RFC 4122.
    */
      ...
      void *pHash)
{
   ...
   for (vma = mm->mmap; vma != NULL; vma = vma->vm_next) {
      if ((vma->vm_flags & VM_EXECUTABLE) != 0 && vma->vm_file != NULL) {
         ...
         dprintk(
               ...
               KERN_DEBUG " Found executable VMA for inode %lu (%lu bytes).\n",
               dentry->d_inode->i_ino,
               (unsigned long)(dentry->d_inode->i_size));

         start = do_mmap(
               vma->vm_file, 0, dentry->d_inode->i_size,
               PROT_READ | PROT_WRITE | PROT_EXEC, MAP_PRIVATE, 0);
         if ((int)start < 0) {
            dprintk(
                  KERN_ERR "SCXLNXConnGetCurrentProcessHash:"
                  KERN_ERR " do_mmap failed (error %d) !\n",
                  (int)start);
            dput(dentry);
            nResult = -EFAULT;
            goto vma_out;
         ...
         while (cur < end) {
            ...
            if (copy_from_user(buffer, (const void *)cur, chunk) != 0) {
               dprintk(
                     KERN_ERR "SCXLNXConnGetCurrentProcessHash:"
                     KERN_ERR " copy_from_user failed!\n");
               nResult = -EINVAL;
   ...
   for (vma = mm->mmap; vma != NULL; vma = vma->vm_next) {
      if ((vma->vm_flags & VM_EXECUTABLE) != 0 && vma->vm_file != NULL) {
...
#ifndef NDEBUG
         {
            ...
            for (pChar = endpath; pChar < buffer + PAGE_SIZE; pChar++) {
               dprintk("%c", *pChar);
            }
         ...
         sha1_update(&sha1Context, (const u8 *) &(CURRENT_UID), sizeof(CURRENT_UID));
         sha1_update(&sha1Context, (const u8 *) &(CURRENT_EUID), sizeof(CURRENT_EUID));
...
void *internal_kmalloc(size_t nSize, int nPriority)
{
   ...
   if (pResult != NULL) {
      atomic_inc(&g_SCXLNXDeviceMonitor.sDeviceStats.stat_memories_allocated);
   }
...
{
   if (pMemory != NULL) {
      atomic_dec(&g_SCXLNXDeviceMonitor.sDeviceStats.stat_memories_allocated);
   }
...
{
   if (pPage != 0) {
      atomic_dec(&g_SCXLNXDeviceMonitor.sDeviceStats.stat_pages_allocated);
   }
...
unsigned long internal_get_free_pages(int nPriority, unsigned int order)
{
   ...
   if (nResult != 0) {
      atomic_add((0x1 << order), &g_SCXLNXDeviceMonitor.sDeviceStats.stat_pages_allocated);
   }
...
{
   if (addr != 0) {
      atomic_sub((0x1 << order), &g_SCXLNXDeviceMonitor.sDeviceStats.stat_pages_allocated);
   }
      ...
      struct vm_area_struct **vmas)
{
   ...
   if (nResult > 0) {
      atomic_add(nResult, &g_SCXLNXDeviceMonitor.sDeviceStats.stat_pages_locked);
   }
