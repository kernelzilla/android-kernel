...
static struct init_table const tpo_nv_a9_to_a11_init[] = 
{
...
{
   { 0x2800,         0x0000 }, /* display turn OFF */
   { 0x1000,         0x0000 }, /* enter sleep mode */
...
static int __init mddi_tpo_nv_init(void)
{
   ...
   {
      printk("%s: panel appears to be missing. Continue\n", __FUNCTION__);
