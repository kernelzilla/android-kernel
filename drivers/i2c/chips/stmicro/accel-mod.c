...
//	sema_init (&accel_info.sema2, 1);
	...
	accel_info.early_suspend.level = EARLY_SUSPEND_LEVEL_BLANK_SCREEN + 8;
#endif
...
#else
		i2c_smbus_write_byte_data (accel_info.i2c, ACCEL_I2C_PORT_INT1_CFG, accel_safe.registers.int1_cfg);
		i2c_smbus_write_byte_data (accel_info.i2c, ACCEL_I2C_PORT_INT1_THS, accel_safe.registers.int1_ths);
		i2c_smbus_write_byte_data (accel_info.i2c, ACCEL_I2C_PORT_INT1_DUR, accel_safe.registers.int1_dur);
		i2c_smbus_write_byte_data (accel_info.i2c, ACCEL_I2C_PORT_INT2_CFG, accel_safe.registers.int2_cfg);
		i2c_smbus_write_byte_data (accel_info.i2c, ACCEL_I2C_PORT_INT2_THS, accel_safe.registers.int2_ths);
		i2c_smbus_write_byte_data (accel_info.i2c, ACCEL_I2C_PORT_INT2_DUR, accel_safe.registers.int2_dur);

		i2c_smbus_write_byte_data (accel_info.i2c, ACCEL_I2C_PORT_REG5, accel_safe.registers.ctrl_5);
		i2c_smbus_write_byte_data (accel_info.i2c, ACCEL_I2C_PORT_REG4, accel_safe.registers.ctrl_4);
		i2c_smbus_write_byte_data (accel_info.i2c, ACCEL_I2C_PORT_REG3, accel_safe.registers.ctrl_3);
		i2c_smbus_write_byte_data (accel_info.i2c, ACCEL_I2C_PORT_REG2, accel_safe.registers.ctrl_2);
		i2c_smbus_write_byte_data (accel_info.i2c, ACCEL_I2C_PORT_REG1, accel_safe.registers.ctrl_1);
#endif
