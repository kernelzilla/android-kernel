...
#include "mt9p012_hp.h"
#include "oldisp/isp.h"

#define DRIVER_NAME  "mt9p012"
#define MOD_NAME "MT9P012: "

#define I2C_INITIAL_LIST_REV1_6_SIZE	18
#define I2C_INITIAL_LIST_REV7_8_SIZE	18
#define I2C_CONFIG_FRAME_LIST_SIZE	23
#define FRAME_648_120fps_ADDENDUM_LIST_SIZE 10
#define FRAME_SOLID_COLOR_ADDENDUM_LIST_SIZE 12

#define I2C_M_WR 0

static unsigned char initial_list_buf_rev1_6[][4] = {
	/* RESET_REGISTER */
	{0x30, 0x1A, 0x10, 0xC8},
	/* GROUPED_PAR_HOLD */
	{0x01, 0x04, 0x01, 0x00},
	/* RESERVED_MFR_3064 */
	{0x30, 0x64, 0x08, 0x05},
	/* Recommended values for image quality, sensor Rev 1-6 */
	{0x30, 0x88, 0x6F, 0xFB},
	{0x30, 0x8E, 0x20, 0x20},
	{0x30, 0x9E, 0x44, 0x00},
	{0x30, 0xD4, 0x90, 0x80},
...
static struct i2c_msg initial_list_rev1_6[] = {
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[0][0]},
	{MT9P012_I2C_ADDR, 0x0, 3, &initial_list_buf_rev1_6[1][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[2][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[3][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[4][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[5][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[6][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[7][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[8][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[9][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[10][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[11][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[12][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[13][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[14][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[15][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev1_6[16][0]},
	{MT9P012_I2C_ADDR, 0x0, 3, &initial_list_buf_rev1_6[17][0]},
};

static unsigned char initial_list_buf_rev7_8[][4] = {
	/* RESET_REGISTER */
	{0x30, 0x1A, 0x10, 0xC8},
	/* GROUPED_PAR_HOLD */
	{0x01, 0x04, 0x01, 0x00},
...
static struct i2c_msg initial_list_rev7_8[] = {
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[0][0]},
	{MT9P012_I2C_ADDR, 0x0, 3, &initial_list_buf_rev7_8[1][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[2][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[3][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[4][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[5][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[6][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[7][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[8][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[9][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[10][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[11][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[12][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[13][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[14][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[15][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &initial_list_buf_rev7_8[16][0]},
	{MT9P012_I2C_ADDR, 0x0, 3, &initial_list_buf_rev7_8[17][0]},
};

#define TBD_VAL 0x00  /* value filled in by mt9p012_configure_frame */
...
static struct i2c_msg config_frame_list[] = {
	/* hold */
	{MT9P012_I2C_ADDR, 0x0, 3, &config_frame_list_buf[0][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[1][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[2][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[3][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[4][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[5][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[6][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[7][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[8][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[9][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[10][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[11][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[12][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[13][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[14][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[15][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[16][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[17][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[18][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[19][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[20][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &config_frame_list_buf[21][0]},
	/* update */
	{MT9P012_I2C_ADDR, 0x0, 3, &config_frame_list_buf[22][0]},
};
...
static struct i2c_msg frame_648_120fps_addendum[] = {
	/* hold */
	{MT9P012_I2C_ADDR, 0x0, 3, &frame_648_120fps_addendum_buf[0][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_648_120fps_addendum_buf[1][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_648_120fps_addendum_buf[2][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_648_120fps_addendum_buf[3][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_648_120fps_addendum_buf[4][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_648_120fps_addendum_buf[5][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_648_120fps_addendum_buf[6][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_648_120fps_addendum_buf[7][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_648_120fps_addendum_buf[8][0]},
	/* update */
	{MT9P012_I2C_ADDR, 0x0, 3, &frame_648_120fps_addendum_buf[9][0]},
};
...
static struct i2c_msg frame_solid_color_addendum[] = {
	/* hold */
	{MT9P012_I2C_ADDR, 0x0, 3, &frame_solid_color_addendum_buf[0][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_solid_color_addendum_buf[1][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_solid_color_addendum_buf[2][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_solid_color_addendum_buf[3][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_solid_color_addendum_buf[4][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_solid_color_addendum_buf[5][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_solid_color_addendum_buf[6][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_solid_color_addendum_buf[7][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_solid_color_addendum_buf[8][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_solid_color_addendum_buf[9][0]},
	{MT9P012_I2C_ADDR, 0x0, 4, &frame_solid_color_addendum_buf[10][0]},
	/* update */
	{MT9P012_I2C_ADDR, 0x0, 3, &frame_solid_color_addendum_buf[11][0]},
};

/**
 * mt9p012_write_regs - writes an array of address/data information
...
static enum mt9p012_frame_type current_iframe = MT9P012_FRAME_1296_30FPS;
static enum v4l2_power current_power_state = V4L2_POWER_OFF;
static struct mt9p012_clock_freq current_clk = {
	.x_clk = MT9P012_XCLK_NOM_2
};
...
mt9p012_read_reg(struct i2c_client *client, u16 data_length, u16 reg, u32 *val)
{
	...
	if (!client->adapter)
		return -ENODEV;
	if (data_length != I2C_MT9P012_8BIT && data_length != I2C_MT9P012_16BIT
			&& data_length != I2C_MT9P012_32BIT)
		return -EINVAL;
	...
	if (err >= 0) {
		*val = 0;
		...
		if (data_length == I2C_MT9P012_8BIT)
			*val = data[0];
		else if (data_length == I2C_MT9P012_16BIT)
			*val = data[1] + (data[0] << 8);
		else
			*val = data[3] + (data[2] << 8) +
				(data[1] << 16) + (data[0] << 24);
...
/**
 * Write a value to a register in mt9p012 sensor device.
 ...
 * Returns zero if successful, or non-zero otherwise.
 */
static int mt9p012_write_reg(struct i2c_client *client, u16 length,
						u16 reg, u32 val)
{
	int err = 0;
	struct i2c_msg msg[1];
...
retry:
	...
	data[0] = (u8) (reg >> 8);
	data[1] = (u8) (reg & 0xff);
	if (length == I2C_MT9P012_8BIT) {
		data[2] = val & 0xff;
	} else if (length == I2C_MT9P012_16BIT) {
		data[2] = (val >> 8) & 0xff;
		data[3] = val & 0xff;
	} else {
		data[2] = (val >> 24) & 0xff;
 ...
 * returned.
 */
int mt9p012_set_exposure_time(u32 exp_time, struct v4l2_int_device *s,
							struct vcontrol *lvc)
{
	int err = 0;
	struct mt9p012_sensor *sensor = s->priv;
	struct i2c_client *client = sensor->i2c_client;
	struct mt9p012_sensor_settings *ss = &sensor_settings[current_iframe];
	...
	if ((current_power_state == V4L2_POWER_ON) || sensor->resuming) {
      ...
      if (exp_time > max_exposure_time) {
		...
		if (coarse_int_time != ss->exposure.coarse_int_tm) {
			err = mt9p012_write_reg(client, I2C_MT9P012_16BIT,
 ...
 * @s: pointer to standard V4L2 device structure
 * @lvc: pointer to V4L2 analog gain entry in mt9p012_video_control array
 *
 * If the requested analog gain is within the allowed limits, the HW
 * is configured to use the new gain value, and the mt9p012_video_control
 * array is updated with the new current value.
 * The function returns 0 upon success.  Otherwise an error code is
 * returned.
 */
int mt9p012_set_gain(u16 linear_gain_q8, struct v4l2_int_device *s,
							struct vcontrol *lvc)
{
	int err = 0;
	...
	struct i2c_client *client = sensor->i2c_client;
	struct mt9p012_sensor_settings *ss = &sensor_settings[current_iframe];
	int rev = (sensor->sensor_id).revision;
	...
	if ((current_power_state == V4L2_POWER_ON) || sensor->resuming) {
		...
		if (rev >= 7)
			digital_gain_bp = 12;	/* Sensor Rev >= 7 */
		else
			digital_gain_bp = 9;	/* Sensor Rev < 7 */
		...
		if (analog_gain_code < MT9P012_MIN_ANALOG_GAIN) {
			analog_gain_code = MT9P012_MIN_ANALOG_GAIN;
			dev_err(&client->dev, "Gain=%d out of legal range.\n",
				linear_gain_q8);
			dev_err(&client->dev, "Gain must be greater than %d \n",
				MT9P012_MIN_LINEAR_GAIN);
		}
 ...
 */
int mt9p012_update_clocks(u32 xclk, enum mt9p012_frame_type iframe)
{
	...
	printk(KERN_DEBUG "MT9P012: xclk=%u, pll_clk=%u, " \
...
/**
 * mt9p012_set_color_bar_mode - puts sensor in color bar test mode
 * @enable: 0 = off, 1 = on
 * @s: pointer to standard V4L2 device structure
 * @lvc: pointer to V4L2 exposure entry in video_controls array
 ...
 * returned.
 */
int mt9p012_set_color_bar_mode(u16 enable, struct v4l2_int_device *s,
							struct vcontrol *lvc)
{
	int err = 0;
	struct mt9p012_sensor *sensor = s->priv;
			...
			struct v4l2_fract *fper, enum mt9p012_frame_type iframe)
{
	...
	/* fper is range checked in mt9p012_calc_xclk */
	...
	if ((current_power_state == V4L2_POWER_ON) || sensor->resuming) {
		...
		mt9p012_write_reg(client, I2C_MT9P012_16BIT,
							...
							unsigned int height)
{
	...
	for (isize = MT9P012_BIN4XSCALE; isize <= MT9P012_FIVE_MP; isize++) {
		if (mt9p012_sizes[isize].height *
			...
			if ((pixels > CIF_PIXELS) && (isize == MT9P012_BIN4X)) {
				isize = MT9P012_BIN2X;
...
/**
 * mt9p012_find_frame_index - Find the frame index that matches the
 ...
 */
static unsigned long mt9p012_calc_xclk(struct v4l2_int_device *s)
{
	int qvga_120 = 0;
	unsigned long xclk;
	struct mt9p012_sensor *sensor = s->priv;
	...
	if ((pix->width <= VIDEO_WIDTH_4X_BINN) && (sensor->fps > 15) &&
							(!qvga_120))
		xclk = MT9P012_XCLK_NOM_2;
	else
		xclk = MT9P012_XCLK_NOM_1;
	*/
			...
			struct v4l2_int_device *s, struct vcontrol *lvc)
{
	...
	if ((current_power_state == V4L2_POWER_ON) || sensor->resuming) {
		...
		err = mt9p012_write_reg(client, I2C_MT9P012_8BIT,
					REG_IMAGE_ORIENTATION, orient);

		v4l_info(client, "mt9p012 orientation = 0x%x\n", orient);
	}
 ...
 */
int mt9p012_configure_frame(enum mt9p012_frame_type iframe)
{
	u16 data;
	...
	/* I2C_REG_READ_MODE */
	if (mt9p012.sensor_id.revision <= 6) {
		/* rev 1-6 */
...
static int mt9p012_configure(struct v4l2_int_device *s)
{
	...
	int err = 0, i = 0;
	u32 xclk;
	enum mt9p012_image_size isize = 0;
	enum mt9p012_frame_type iframe = 0;
	...
	if (rev <= 6) {
		/* rev 1-6 init */
		err = mt9p012_write_regs(client, initial_list_rev1_6,
			I2C_INITIAL_LIST_REV1_6_SIZE);
		if (err)
			return err;
	} else {
		/* rev 7-8 init */
		err = mt9p012_write_regs(client, initial_list_rev7_8,
			I2C_INITIAL_LIST_REV7_8_SIZE);
		if (err)
			return err;
	}

	/* Determine Xclk & range check Frame Rate */
	xclk = mt9p012_calc_xclk(s);
	...
	if (pix->pixelformat == V4L2_PIX_FMT_SGRBG10) {
		...
		mt9p012_configure_frame(iframe);

		err = mt9p012_write_regs(client, config_frame_list,
	...
	v4l_info(client, "mt9p012_configure: fps=%d, isize=%d, iframe=%d\n",
		sensor->fps, isize, iframe);

	if (err)
		return err;

	mt9p012_update_clocks(xclk, iframe);
	...
	if (pix->pixelformat != V4L2_PIX_FMT_W1S_PATT) {
		...
		if (i >= 0) {
			lvc = &video_control[i];
			mt9p012_set_color_bar_mode(lvc->current_value,
				sensor->v4l2_int_device, lvc);
		}
	}
	...
	/* start streaming */
	mt9p012_write_reg(client, I2C_MT9P012_8BIT, REG_MODE_SELECT, 1);
	mdelay(1);
 ...
 *	mt9p012 Revision 1 thru mt9p012 Revision 8
 * Returns a negative error number if no device is detected, or the
 * non-negative value of the version ID register if a device is detected.
 */
static int
mt9p012_detect(struct v4l2_int_device *s)
{
	struct mt9p012_sensor *sensor = s->priv;
	struct i2c_client *client = sensor->i2c_client;
	...
	if (mt9p012_read_reg(client, I2C_MT9P012_16BIT,
				REG_MODEL_ID, &model_id))
		return -ENODEV;

	if (mt9p012_read_reg(client, I2C_MT9P012_8BIT,
	...
	if (mt9p012_write_reg(client, I2C_MT9P012_16BIT, REG_RESET_REGISTER,
	...
	if (mt9p012_write_reg(client, I2C_MT9P012_16BIT,
				REG_RESET_REGISTER, reset_data))
		return -ENODEV;
	...
	if ((mfr_id != MT9P012_MFR_ID) ||
		(sensor_revision <= 6 && model_id != MT9P012_MOD_ID_REV1_6) ||
		(sensor_revision >= 7 && model_id != MT9P012_MOD_ID_REV7_8)) {
			     ...
			     struct v4l2_control *vc)
{
	...
	case V4L2_CID_GAIN:
		...
		break;
	case V4L2_CID_PRIVATE_COLOR_BAR:
		retval = mt9p012_set_color_bar_mode(vc->value, s, lvc);
		break;
	case V4L2_CID_PRIVATE_FLASH_NEXT_FRAME:
			     ...
			     struct v4l2_streamparm *a)
{
	...
	xclk = mt9p012_calc_xclk(s);
	mt9p012_update_clocks(xclk, current_iframe);
	mt9p012_set_framerate(s, &sensor->timeperframe, current_iframe);
...
static int ioctl_s_power(struct v4l2_int_device *s, enum v4l2_power on)
{
	...
	c->addr = MT9P012_I2C_ADDR;
#endif

	if ((on == V4L2_POWER_STANDBY) && (sensor->state == SENSOR_DETECTED))
		mt9p012_write_reg(c, I2C_MT9P012_8BIT, REG_MODE_SELECT, 0);

	if (on != V4L2_POWER_ON)
		isp_set_xclk(0, MT9P012_USE_XCLKA);
	else
		isp_set_xclk(current_clk.x_clk, MT9P012_USE_XCLKA);
...
{
	int err;
	err = i2c_add_driver(&mt9p012_i2c_driver);
	if (err) {
